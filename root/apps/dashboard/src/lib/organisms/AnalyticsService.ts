...
import { getAnalyticsDashboard, type AnalyticsDashboardData } from '../molecules/analytics-aggregator'
...
export class AnalyticsService {
    ...
    async clearMetrics(): Promise<{ success: boolean; error?: string }> {
        ...
        const { dbClearAnalytics } = await import('../atoms/database/db-clear-analytics')
